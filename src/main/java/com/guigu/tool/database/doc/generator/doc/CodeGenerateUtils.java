...
import com.guigu.tool.database.doc.generator.bean.ColumnClass;
...
public class CodeGenerateUtils {
    ...
    private final String AUTHOR = "majun";
    private final String CURRENT_DATE = "2020/07/03";
    private final String tableName = "ay_test";
    private final String packageName = "com.guigu.pm.process.manage";
    private final String tableAnnotation = "质量问题";
    private final String URL = "jdbc:mysql://localhost:3306/mybatis_demo?useUnicode=true&characterEncoding=UTF-8&useSSL=false";
    private final String USER = "root";
    private final String PASSWORD = "root";
    private final String DRIVER = "com.mysql.jdbc.Driver";
    private final String diskPath = "D:/tmp/doc/";
